...
```
Repo : 
https://github.com/hienpham94/argocd-example-apps.git
...
argocd app create guestbookcli --repo https://github.com/hienpham94/argocd-example-apps.git --path guestbook --dest-server https://kubernetes.default.svc --dest-namespace default
